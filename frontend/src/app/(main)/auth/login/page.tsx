    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#ddeeff] via-[#aaccff] to-[#88aaff] p-4">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold">LMS - Sistem Ujian Online</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-sm text-center text-muted-foreground mt-4">
              <p>Demo Login:</p>
              <p className="text-xs mt-1">Admin: admin / password</p>
              <p className="text-xs">Guru: guru / password</p>
              <p className="text-xs">Siswa: siswa / password</p>
            </div>
          </form>
        </CardContent>
      </Card>
